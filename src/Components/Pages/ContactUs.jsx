  ...
  return (
    ...
    <div className='bg-[#F6F5F7] px-5 py-5 md:px-32 md:py-10'>
        <div className="bg-white rounded-lg px-5 py-5 md:px-0 md:py-0 md:flex justify-center items-center ">
            ...
            <p className='font-medium md:text-[#707070] md:text-xl md:py-3'>Full Name</p>
            <input type="text" className='bg-[#F5F5F5] px-5 py-2 w-full rounded-lg outline-none md:py-3' placeholder='Name' />
            </div>
            <div className='my-2 md:my-5'>  
            <p className='font-medium md:text-[#707070] md:text-xl md:py-3'>Email Address</p>
            ...
            <div className='my-2 md:my-5'>  
            <p className='font-medium md:text-[#707070] md:text-xl md:py-3'>How can we help?</p>
            ...
            <button className='text-white md:text-lg my-5 font-semibold bg-[#023D65] rounded-lg px-5 py-3  w-full'>Submit</button>
