...
const Banner = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-2 md:flex-row md:flex justify-between md:gap-80"> 
          ...
          <button className="bg-[#023D65] text-white rounded-lg px-2 py-2 mt-1 w-36 md:px-5 md:py-3  md:w-64 mt-5 md:mt-14 font-medium text-sm md:text-lg">Create New Event</button>
          </div>
